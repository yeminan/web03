         ...
         <div class="content_wrap">
             <section class="page" id="page1">
                 <figure class="sub_ban">
                     <img src="./img/subvisual5.jpg" alt="기업개요">
                     <div class="tit_box">
                         <h2 class="sub_tit">경영정보</h2>
                         <p class="sub_com">.</p>
                     </div>
                 </figure>
                 <div class="bread_box">
                     <div class="bread_wrap">
                         <ul class="bread">
                             ...
                             <li class="item2">투자정보</li>
                             <li class="item3">
                                 <select name="sel" id="sel1"class="sel">
                                     <option value="investment.jsp#page1" selected>경영정보</option>
                                     <option value="investment.jsp#page2">재무정보</option>
                                     <option value="investment.jsp#page3">주식정보</option>
                                     <option value="investment.jsp#page4">IR정보</option>
                                 </select>
                             </li>
                         </ul>
                     </div>
                                     ...
                                     <ul class="bread">
                                         ...
                                         <li class="item3">
                                             <select name="sel" id="sel2"class="sel">
                                                <option value="investment.jsp#page1">경영정보</option>
                                                <option value="investment.jsp#page2"selected>재무정보</option>
                                                <option value="investment.jsp#page3">주식정보</option>
                                                <option value="investment.jsp#page4">IR정보</option>
                                             </select>
                                         </li>
                              ...
                              <ul class="bread">
                                 ...
                                 <li class="item3">
                                    <select name="sel" id="sel3"class="sel">
                                        <option value="investment.jsp#page1">경영정보</option>
                                        <option value="investment.jsp#page2">재무정보</option>
                                        <option value="investment.jsp#page3"selected>주식정보</option>
                                        <option value="investment.jsp#page4">IR정보</option>
                          </select>
                     </li>
                </ul>
                  ...
                  <ul class="bread">
                     ...
                     <li class="item3">
                        <select name="sel" id="sel4"class="sel">
                            ...
                            <option value="investment.jsp#page2">재무정보</option>
                            <option value="investment.jsp#page3">주식정보</option>
                            <option value="investment.jsp#page4"selected>IR 정보</option>
              </select>
         </li>
    </ul>
    </div>
