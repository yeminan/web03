...
<head>
    ...
    /* 내게 필요한 스타일 초기화 */
    * { margin: 0;padding: 0; }
    body, html { font-family: 'Noto Sans KR', sans-serif; width: 100%; } 
    ul { list-style: none; } 
    a { text-decoration: none; color: #333; }
    .vs_tit { font-family: 'scB'; } 
    .vs_com { font-family: 'Nanum Gothic', sans-serif; } 
    ...
    .img_box li a img { display:block; width: 100%; }
    ...
    .vs_com { font-size:16px; padding-top: 10%; }
    ...
    .grid_wrap li.item1 { background-color: #4340dde3; } 
    .grid_wrap li.item2 { background-color: #00518f; } 
    .grid_wrap li.item3 { background-color: #326083 } 
    .grid_wrap li.item4 { background-image: url("./img/mainCon_bg2.jpg"); background-position: 28%;}
    .grid_wrap li.item5 { background-image: url("./img/susu.jpg");  background-position: 20%;}
    .grid_wrap li.item6 { background-image: url("./img/mainCon_bg3\ \(1\).jpg"); background-position: 50%; }
    ...
    .col5 { width: 41.66667%; }
    .col6 { width: 50%; }
    .grid_wrap li a { display:block; padding: 15px; }
    .col_tit, .col_com { color:rgb(255, 255, 255); }
    .col_tit { padding-top: 26px; }
    .col_tit.w , .col_com.w { color:#fff; text-shadow:1px 1px 1px #333; }
    .col_tit.w { padding-top: 10%; }
    .arrow { display:block; margin-top: 50px; }
    .arrow:before { content:""; display:block; width:2px; height:5px; 
    border-bottom:0px solid rgb(0, 0, 0); float:left; transition:0.8s; }
    .arrow:after { content:""; display:block; width: 122px; height: 8px; 
    background-image: url("./images/main_over_btn.png"); float:left ; }
    .col_com { font-size:16px; padding-top: 20px; font-weight: 200;  }
	...
	<div id="content">
            <div id="vs">
                <ul class="img_box">
                    <li>
                        <a href="" >
                            <img src="./img/hyundaemainbg1.jpg" alt="투자정보" class="pic1">
                            <div class="tit_box">
                                <h2 class="vs_tit">디지털 세상으로 <br>연결해주는 </h2>
                    ...
                    <li>
                        <a href="">
                            <img src="./img/hyundaemainbg2.jpg" alt="클로벌" class="pic">
                            <div class="tit_box">
                                <h2 class="vs_tit">현대글로비스, 'ECOH'로 달린다</h2>
                    ...
                    <li>
                        <a href="">
                            <img src="./img/hyundaemainbg3.jpg" alt="사회공헌" class="pic">
                            <div class="tit_box">
                    ...
                    <li>
                        <a href="">
                            <img src="./img/hyundaemainbg4.jpg" alt="윤리경연" class="pic">
                            <div class="tit_box">
                                <h2 class="vs_tit">OLED Microsite 오픈</h2>
                                <p class="vs_com">현대글로비스 만나보세요!</p>
                            </div>
                        </a>
                    </li>
                </ul>
                ...
                <ul class="grid_wrap">
                    ...
                    <li class="col2 item3">
                        <a href="">
                            ...
                            <p class="col_com">현대글로비스는 도전, 창의, 열정을 가진 전문 인재를 기다립니다.</p>
                            <span class="arrow"></span>
                        </a>
                    </li>
                    <li class="col2 item4">
                        <a href="">
                            ...
                            <p class="col_com w">Why 현대 글로비스</p>
                        </a>
                    </li>
                    <li class="col2 item5">
                        <a href="">
